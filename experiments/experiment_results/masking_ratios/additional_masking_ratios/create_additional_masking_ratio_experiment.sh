...
BASE="/home/ubuntu/smiles_encoder/experiments/additional_masking_ratios"
...
dataset="fabikru/half-of-chembl-2025-randomized-smiles-cleaned"
size="15M"

# Define the additional masking ratios to test
masking_ratios=("0.7" "0.8" "0.9")

# Extract dataset key (everything after the last slash)
dataset_key="${dataset##*/}"

# Determine optimal learning rate (eta) and batch size for 15M model with small dataset
eta=0.003439
batch_size=256
